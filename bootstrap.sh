...
folders_to_create=(
    ...
    "${HOME}/.config/nvim/lua/core_plugins/lsp"
...
# TODO: change how this works. super error prone
DOTFILES=(
    ".bashrc"
    ".fehbg"
    ".inputrc"
    ...
    ".config/nvim/lua/core_config/helpers.lua"
    ".config/nvim/lua/core_config/keybinds.lua"
    ".config/nvim/lua/core_config/plugins.lua"
    ".config/nvim/lua/core_config/settings.lua"
    ".config/nvim/lua/core_plugins/autopairs.lua"
    ".config/nvim/lua/core_plugins/colorizer.lua"
    ".config/nvim/lua/core_plugins/colour.lua"
    ".config/nvim/lua/core_plugins/comment.lua"
    ".config/nvim/lua/core_plugins/copilot.lua"
    ".config/nvim/lua/core_plugins/formatter.lua"
    ".config/nvim/lua/core_plugins/gruvbox.lua"
    ".config/nvim/lua/core_plugins/lsp-installer.lua"
    ".config/nvim/lua/core_plugins/lualine.lua"
    ".config/nvim/lua/core_plugins/material.lua"
    ".config/nvim/lua/core_plugins/nvim-tree.lua"
    ".config/nvim/lua/core_plugins/telescope.lua"
    ".config/nvim/lua/core_plugins/telescope-file-browser.lua"
    ".config/nvim/lua/core_plugins/toogle-lsp-diagnostics.lua"
    ".config/nvim/lua/core_plugins/toogle-term.lua"
    ".config/nvim/lua/core_plugins/treesiter.lua"
    ".config/nvim/lua/core_plugins/lsp/lsp-cmp.lua"
    ".config/nvim/lua/core_plugins/lsp/lsp-config.lua"
)
